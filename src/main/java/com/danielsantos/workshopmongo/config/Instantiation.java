package com.danielsantos.workshopmongo.config;
...
import com.danielsantos.workshopmongo.dto.AuthorDTO;
import com.danielsantos.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Bos Férias!", sdf.parse("26/03/2018"), new AuthorDTO (bob));
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("29/03/2018"), new AuthorDTO (alex));
